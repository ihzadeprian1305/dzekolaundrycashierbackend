...
class OwnerDataController extends Controller
{
    public function fetch(Request $request)
    {
        try {
            ...
            $ownerUser = User::whereRelation('user_levels', 'name', 'Pemilik');
            
            if($request->search){
                $ownerUser->whereRelation('user_data', 'name', 'like', '%'.$request->search.'%');
            }
    ...
    public function post(Request $request)
    {
        try {
            ...
            $userLevelOwner = UserLevel::where('name', 'Pemilik')->first();
            ...
            return response()->json([
                'status' => 200,
                'success' => true,
                'message' => 'Data Pemilik telah Berhasil Ditambah',
            ], 200);
        } catch(QueryException $error){
            return response()->json([
                'status' => 401,
    ...
    public function delete(Request $request)
    {
        try {
            ...
            return response()->json([
                'status' => 200,
                'success' => true,
                'message' => 'Data Pemilik telah Berhasil Dihapus',
            ], 200);
        } catch(QueryException $error){
            return response()->json([
                'status' => 401,
